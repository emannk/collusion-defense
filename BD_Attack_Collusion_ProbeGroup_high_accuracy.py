...
from models.Nets_high_accuracy import CNNMnist, CNNMnistHighAccuracy, CNNCifar_ResNet18, FastTextBinary
...
if __name__ == '__main__':
    ...
    elif args.model in ('cnn', 'cnn_highacc') and (args.dataset == 'mnist' or args.dataset == 'fashion-mnist'):
        if args.model == 'cnn_highacc':
